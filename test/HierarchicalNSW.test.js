...
describe('HierarchicalNSW', () => {
  describe('#constructor', () => {
    it('throws an error if no arguments are given', () => {
      expect(() => { new HierarchicalNSW() }).toThrowError('wrong number of arguments (given 0, expected 2)');
    });

    it('throws an error if given a non-String object to first argument', () => {
      expect(() => { new HierarchicalNSW(1, 3) }).toThrowError('wrong first argument type, expected String');
    });

    it('throws an error if given a non-Number object to second argument', () => {
      expect(() => { new HierarchicalNSW('l2', '3') }).toThrowError('wrong second argument type, expected Number');
    });
  ...
  describe('#initIndex', () => {
    ...
    it('throws an error if no arguments are given', () => {
      expect(() => { index.initIndex() }).toThrowError('wrong number of arguments (given 0, expected 1..4)');
    });

    it('throws an error if given a non-Number argument', () => {
      expect(() => { index.initIndex('5') }).toThrowError('wrong first argument type, expected Number');
    });
  });
  ...
  describe('#resizeIndex', () => {
    ...
    it('throws an error if no arguments are given', () => {
      expect(() => { index.resizeIndex() }).toThrowError('wrong number of arguments (given 0, expected 1)');
    });

    it('throws an error if given a non-Number argument', () => {
      expect(() => { index.resizeIndex('0') }).toThrowError('wrong argument type, expected Number');
    });
  ...
  describe('#setEf', () => {
    ...
    it('throws an error if no arguments are given', () => {
      expect(() => { index.setEf() }).toThrowError('wrong number of arguments (given 0, expected 1)');
    });

    it('throws an error if given a non-Number argument', () => {
      expect(() => { index.setEf('0') }).toThrowError('wrong argument type, expected Number');
    });
  ...
  describe('#markDelete', () => {
    ...
    it('throws an error if no arguments are given', () => {
      expect(() => { index.markDelete() }).toThrowError('wrong number of arguments (given 0, expected 1)');
    });

    it('throws an error if given a non-Number argument', () => {
      expect(() => { index.markDelete('0') }).toThrowError('wrong argument type, expected Number');
    });
  ...
  describe('#unmarkDelete', () => {
    ...
    it('throws an error if no arguments are given', () => {
      expect(() => { index.unmarkDelete() }).toThrowError('wrong number of arguments (given 0, expected 1)');
    });

    it('throws an error if given a non-Number argument', () => {
      expect(() => { index.unmarkDelete('0') }).toThrowError('wrong argument type, expected Number');
    });
